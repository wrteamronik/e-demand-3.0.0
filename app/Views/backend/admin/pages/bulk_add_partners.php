                ...
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <div class="row mt-4">
                            ...
                            <div class="col-md-6 mb-3">
                                <a href="<?= base_url("admin/partners/Provider-Add-Instructions") ?>" class="btn  btn-lg btn-outline-primary w-100">
                                    <i class="fas fa-arrow-circle-down mr-2"></i>
                                    <?= labels('add_provider_instructions', 'Add Provider Instructions') ?></a>
                            </div>
                            <div class="col-md-6 mb-3">
                                <a href="<?= base_url("admin/partners/Provider-Update-Instructions") ?>" class="btn  btn-lg btn-outline-primary w-100">
                                    <i class="fas fa-arrow-circle-down mr-2"></i><?= labels('update_provider_instructions', 'Update Provider Instructions') ?></a>
                            </div>
                        </div>
                    </div>
                </div>
