...
<div class="main-content">
    <section class="section">
        <div class="section-header mt-2">
            <h1><?= labels('edit_email_templates', "Edit Email templates") ?></h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input id="bcc" style="border-radius: 0.25rem!important" class="w-100" type="text" value="<?= ($template['bcc']) ?>" name="bcc[]" placeholder="press enter to add bcc">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label><?= labels('cc', "CC") ?></label>
                                    <input id="cc" style="border-radius: 0.25rem" class="w-100" type="text" name="cc[]" value="<?= $template['cc'] ?>" placeholder="press enter to add cc">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
